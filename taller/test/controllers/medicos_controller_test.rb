...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { apellidos: @medico.apellidos, nombres: @medico.nombres, numeroCelular: @medico.numeroCelular, numeroIdentificacion: @medico.numeroIdentificacion, tipoMedico: @medico.tipoMedico } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { apellidos: @medico.apellidos, nombres: @medico.nombres, numeroCelular: @medico.numeroCelular, numeroIdentificacion: @medico.numeroIdentificacion, tipoMedico: @medico.tipoMedico } }
