...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { apellidos: @paciente.apellidos, fechaNacimiento: @paciente.fechaNacimiento, nombres: @paciente.nombres, numeroDocumento: @paciente.numeroDocumento } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { apellidos: @paciente.apellidos, fechaNacimiento: @paciente.fechaNacimiento, nombres: @paciente.nombres, numeroDocumento: @paciente.numeroDocumento } }
